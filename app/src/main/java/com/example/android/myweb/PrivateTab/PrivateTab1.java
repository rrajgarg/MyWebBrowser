...
public class PrivateTab1 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new PrivateTab1.myWebViewClient());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch(id)
        {
            case R.id.history:
                ...
                Intent intent = new Intent(PrivateTab1.this,History.class);
                startActivity(intent);
                break;
            case R.id.bookmarks:
                Intent intent3 = new Intent(PrivateTab1.this,BookMarks.class);
                startActivity(intent3);
                Toast.makeText(getApplicationContext(),"Bookmarks",Toast.LENGTH_SHORT).show();
                break;
            case R.id.new_private_tab:
                Intent intent2 = new Intent(PrivateTab1.this, PrivateTab2.class);
